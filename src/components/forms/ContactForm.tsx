    ...
    <form onSubmit={handleSubmit} className="space-y-4 max-w-lg" noValidate>
      ...
      <div>
        ...
        <input
          ...
          className={`w-full border rounded-lg px-3 py-2 dark:bg-gray-800 dark:text-white transition-colors focus:outline-none focus:ring-2 ${
            errors.name
      ...
      <div>
        ...
        <textarea
          ...
          className={`w-full border rounded-lg px-3 py-2 resize-y dark:bg-gray-800 dark:text-white transition-colors focus:outline-none focus:ring-2 ${
            errors.message
              ? 'border-red-500 focus:ring-red-500'
              : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500'
          }`}
